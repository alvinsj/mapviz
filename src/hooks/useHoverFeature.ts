...
export const useHoverFeature = (mapRef: MutableRefObject<MapRef | undefined>, layerName: string): MapboxGeoJSONFeature | undefined => {
  ...
  useEffect(() => {
    ...
    return () => {map.off('mousemove', handleMouseMove); return}
